...
class MessageRouter {
  constructor({ customerStore, dialogflowClient, projectId, location, agentId, customerRoom, operatorRoom }) {
  ...
  _routeCustomer(utterance) {
    ...
    //   setTimeout(() => {
    //     this._endSessionTimeoutToAgent(utterance);
    //   }, this.timeout)
